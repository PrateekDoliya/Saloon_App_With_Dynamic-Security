...
public interface RolePermissionDtoRepository extends JpaRepository<RolePermissionDto, Integer> {
	...
	@Query(nativeQuery = true, value = "select r.id,r.employee_id, r.permission_permission_id from employee_service_saloon_app.role_permissions r where r.employee_id=:employeeId and r.role_role_id=:roleId")
